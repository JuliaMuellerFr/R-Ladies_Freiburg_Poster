...
**R-Ladies global:**
  ...
  - aims to achieve proportionate representation
  
  - by encouraging genders currently underrepresented
  
  - in one of the most widely-used statistical programming languages: R!  

learn more in **rladies.org**
:::
...
R is a language for **statistical computing** and **data visualisation** which is  
  ...
  - already the **standard** for statistical analyses  

  - **powerful** and **flexible**  

  - **open-source** and **well-supported**  

Are you wondering what you can do with R? Here some examples:  
