...
ggplot(gendergap, aes(x=position, y=percent, group=gender, color=gender)) +
  ...
  theme_light() +
  labs(title = "Women in data science roles in the EU, 2020",
...
**R-Ladies global:**
  ...
  - is a worldwide organization with hundreds of local chapters
  
  - aims to promote gender diversity in leadership, use, and teaching
  
  - celebrates one of the most widely-used statistical programming languages: R!  

Learn more at **rladies.org**
:::
...
R is a language for **statistical computing** and **data visualisation** which is  
  ...
  - the **standard** for statistical analyses  

  - **powerful** and **flexible**  

  - **open-source** and **well-supported**  

Wondering what you can do with R? Here some examples:  
...
# Join R-Ladies Freiburg! {.mybreak}

**Your local chapter always welcomes new members!**  

```{r, rladies_global, warnings=F,  fig.height= 3.7}
...
**We meet**  
  ...
  - in workshops to discuss one specific topic 
  
  - to do parallel coding
  
  - or sometimes just to have fun

in a safe environment where we can all learn and exchange.

Are you a **complete beginner** or a **total profi**?
You are welcome to learn and share your expertise!
